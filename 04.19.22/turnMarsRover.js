...
function turn(current, target) {
    switch (current) {
        case "N":
            if (target === "E") return "right";
            if (target === "W") return "left";
            break;
        case "E":
            if (target === "S") return "right";
            if (target === "N") return "left";
            break;
        case "S":
            if (target === "W") return "right";
            if (target === "E") return "left";
            break;
        case "W":
            if (target === "N") return "right";
            if (target === "S") return "left";
            break;
    }
}
