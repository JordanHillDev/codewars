...
//P: array of arrays where left number is always less than right number
//R: total number that is all range differences in right and left number

function sumIntervals(intervals) {
    //sorts arrays by first number
