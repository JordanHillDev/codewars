    ...
    moves.forEach((move) => {
        switch (move) {
            ...
            case "down":
                ...
                break;
            case "left":
                position[1] = ((position[1] - 1) % fighters[0].length + fighters[0].length) % fighters[0].length
                break;
            case "right":
                position[1] = ((position[1] + 1) % fighters[0].length + fighters[0].length) % fighters[0].length
                break;
        ...
        chars.push(fighters[position[0]][position[1]])
    });
...
let moves = ['left', 'left', 'left', 'right', 'left', 'left', 'right']
...
((index + n) % array.length + array.length) % array.length