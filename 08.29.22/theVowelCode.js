...
function encode(string) {
    ...
    return string
        .split("")
        .map((char) => {
            if (Object.keys(vowelKeys).includes(char)) {
                return vowelKeys[char];
            }
            return char;
        })
        .join("");
...
function decode(string) {
    ...
    return string
        .split("")
        .map((char) => {
            if (Object.values(vowelKeys).includes(+char)) {
                return Object.keys(vowelKeys).find(
                    (key) => vowelKeys[key] == char
                );
            }
            return char;
        })
